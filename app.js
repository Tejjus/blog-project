...
mongoose.connect(process.env.url+'blogpostDB');
...
app.get('/', async (req, res) => {
  ...
  Post.find().exec()
  .then(posts => {
    res.render('home', {content: homeContent, posts: posts.reverse()});
  })
  .catch((err) => {console.log(err);});

  /* meoemeoemeoemeoemeoeo cat ran over my keyboard
  gonna keep this here for keepsakes */
});

app.get('/posts/:post', (req, res) => {

  Post.findOne({_id: req.params.post}).exec()
  .then(post => {
